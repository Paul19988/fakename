...
@Mod.EventBusSubscriber(value = Side.CLIENT, modid = "fakename")
public class FakenameEventsClient {
...
//                    FakeName.network.sendTo(new FakeNamePacket(player.getEntityData().getString(FakeName.KEY), player.getEntityId(), 0), (EntityPlayerMP) playersTracking.next());
//                }
//            }
//        }
//    }
